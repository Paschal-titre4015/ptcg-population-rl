...
int main(int argc,char** argv) {
    try {
        ...
        for(std::size_t i=0;i<mega_abomasnow_schema::IDS.size();++i) deck[mega_abomasnow_schema::IDS[i]]=mega_abomasnow_schema::COUNTS[i];
        mega_abomasnow_gbdt::Model model(argv[1],mega_abomasnow_schema::ID,mega_abomasnow_schema::NAMES,deck);
        int rows=0,width=0;
