...
from agents.mega_abomasnow.gbdt.rich_features import append as append_rich
...
def check_deck(deck: Sequence[int]) -> None:
    ...
    if Counter(deck) != DECK_COUNTS:
        raise ValueError("Mega Abomasnow ex deck does not match the feature/model contract")
