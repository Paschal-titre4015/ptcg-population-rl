"""Official mega abomasnow rule policy."""

from __future__ import annotations

# Source: https://www.kaggle.com/code/kiyotah/a-sample-rule-based-agent-mega-abomasnow-ex-deck
    ...
    for card in my_state.active:
        ...
        if card.id == Mega_Abomasnow_ex and len(card.energies) >= 2:
            ...
            if not prefer_ky and bench_attacker_index0 >= 0:
                switch_index = (
                    bench_attacker_index0  # Switching to Mega Abomasnow ex is preferable.
                )
                ...
                if (
                    ...
                    if card.id == Snover:
                        ...
                        if (
                            ...
                            and field_counts[card.id] + hand_counts[card.id] == 0
                        ):
                            score += 100
                        else:
                            score += 10
