...
from agents.mega_abomasnow.gbdt.features import DECK_COUNTS, SCHEMA_ID
from agents.mega_abomasnow.gbdt.features import NAMES as GBDT_NAMES
from agents.mega_abomasnow.gbdt.scripts.audit import audit as audit_gbdt
from agents.mega_abomasnow.gbdt.scripts.extract import extract as extract_gbdt
from agents.mega_abomasnow.gbdt.train import train as train_gbdt
from agents.mega_abomasnow.ppo.scripts.collect import DEFAULTS, collect
from agents.mega_abomasnow.ppo.train import train as train_ppo
from agents.mega_abomasnow.transformer.checkpoint import load_checkpoint
from agents.mega_abomasnow.transformer.features import CONTRACT_ID, NAMES
from agents.mega_abomasnow.transformer.scripts.audit import audit as audit_transformer
from agents.mega_abomasnow.transformer.scripts.export import export
from agents.mega_abomasnow.transformer.scripts.extract import extract as extract_transformer
from agents.mega_abomasnow.transformer.train import train as train_transformer

if TYPE_CHECKING:
    from typing import Any


AGENT = "mega_abomasnow"
...
def validate(output: Path, binary: Path, device: str = "cuda") -> dict[str, Any]:
    ...
    gp = audit_gbdt(
        ...
        output / "gbdt_features",
        binary.parent / "mega_abomasnow_gbdt_probe",
    )
    ...
    tp = audit_transformer(
        ...
        output / "distillation",
        binary.parent / "mega_abomasnow_transformer_probe",
        8,
    )
    rollout = collect(
        checkpoint,
