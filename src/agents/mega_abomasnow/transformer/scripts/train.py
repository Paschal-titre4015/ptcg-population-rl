"""Train the official-deck Mega Abomasnow structured Transformer on GBDT replays."""
...
from agents.mega_abomasnow.transformer.features import CONTRACT_ID
from agents.mega_abomasnow.transformer.train import train
