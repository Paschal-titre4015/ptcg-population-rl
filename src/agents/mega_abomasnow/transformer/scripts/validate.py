...
from agents.mega_abomasnow.transformer.scripts.audit import ROOT, audit
...
def validate(
    ...
    matchups = [
        ("mega_abomasnow_transformer", "mega_abomasnow_gbdt"),
        ("mega_abomasnow_gbdt", "mega_abomasnow_transformer"),
        ("mega_abomasnow_transformer", "mega_abomasnow_transformer"),
    ]
    results = []
    with tempfile.TemporaryDirectory() as temporary:
        ...
        for i, (a, b) in enumerate(matchups):
            command = [
                ...
                b,
                "--deck-a",
                str(ROOT / "src/agents/mega_abomasnow/deck.csv"),
                "--deck-b",
                str(ROOT / "src/agents/mega_abomasnow/deck.csv"),
                "--games",
                "2",
