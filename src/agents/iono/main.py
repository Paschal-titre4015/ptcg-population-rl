"""Official iono rule policy."""

from __future__ import annotations

# Source: https://www.kaggle.com/code/kiyotah/a-sample-rule-based-agent-iono-s-deck
        ...
        if o.type == OptionType.NUMBER:
                ...
                if (
                    ...
                    if c.id == Basic_Lightning_Energy:
                        ...
                        if field_pokemon1 == 0:
                            ...
                            if op_prize >= 3 or (
                                op_prize >= 2 and field_counts[Iono_Bellibolt_ex] == 0
                            ):
                                score += 20
                    elif c.id == Iono_Bellibolt_ex:
            ...
            if data.cardType == CardType.STADIUM:
                ...
                if c.id == Iono_Voltorb and field_counts[Iono_Voltorb] >= 2:
                    ...
                    if (
                        op_prize >= 2
                        or field_counts[Iono_Voltorb] == 0
                        or field_counts[Iono_Bellibolt_ex] == 0
                    ):
                        score = -1
            else:
                if c.id == Night_Stretcher:
                    if (
                        ...
                        or (
                            discard_counts[Iono_Bellibolt_ex] > 0 and field_counts[Iono_Tadbulb] > 0
                        )
                    ...
                    if no_more_pokemon or state.turn <= 2:
                        ...
                        field_hand_counts[Iono_Bellibolt_ex] > 0
