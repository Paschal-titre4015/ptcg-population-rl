...
from agents.iono.gbdt.features import DECK_COUNTS, SCHEMA_ID
from agents.iono.gbdt.features import NAMES as GBDT_NAMES
from agents.iono.gbdt.scripts.audit import audit as audit_gbdt
from agents.iono.gbdt.scripts.extract import extract as extract_gbdt
from agents.iono.gbdt.train import train as train_gbdt
from agents.iono.ppo.scripts.collect import DEFAULTS, collect
from agents.iono.ppo.train import train as train_ppo
from agents.iono.transformer.checkpoint import load_checkpoint
from agents.iono.transformer.features import CONTRACT_ID, NAMES
from agents.iono.transformer.scripts.audit import audit as audit_transformer
from agents.iono.transformer.scripts.export import export
from agents.iono.transformer.scripts.extract import extract as extract_transformer
from agents.iono.transformer.train import train as train_transformer
...
def validate(output: Path, binary: Path, device: str = "cuda") -> dict[str, Any]:
    ...
    tp = audit_transformer(
        ...
        output / "distillation",
        binary.parent / "iono_transformer_probe",
        8,
    )
    rollout = collect(
        checkpoint,
