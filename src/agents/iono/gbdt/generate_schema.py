...
from agents.iono.gbdt.rich_features import names as rich_names
from agents.iono.transformer.features import CONTRACT_ID, SCORE_TIE_TOLERANCE

SCHEMA_PATH = ROOT / "src/agents/iono/gbdt/schema.json"
...
if __name__ == "__main__":
    generate(ROOT / "build/generated/iono_schema.h")
