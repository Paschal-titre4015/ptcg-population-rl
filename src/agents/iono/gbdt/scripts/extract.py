...
from agents.iono.gbdt.features import NAMES, SCHEMA, SCHEMA_ID, action_queries, check_deck
...
def main() -> None:
    ...
    p.add_argument("--replay-dir", type=Path, default=ROOT / "outputs/iono/rule_replays")
    p.add_argument("--output-dir", type=Path, default=ROOT / "outputs/iono/gbdt_features")
