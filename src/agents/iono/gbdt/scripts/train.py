"""Train and export the Iono GBDT from extracted game-split features."""
...
from agents.iono.gbdt.features import DECK_COUNTS, NAMES, SCHEMA_ID
from agents.iono.gbdt.train import train


def main() -> None:
    """Parse command-line arguments and run this tool."""
    p = argparse.ArgumentParser(description=__doc__)
    p.add_argument("--feature-dir", type=Path, default=ROOT / "outputs/iono/gbdt_features")
    p.add_argument("--output-dir", type=Path, default=ROOT / "models/iono")
    p.add_argument(
        "--profile",
