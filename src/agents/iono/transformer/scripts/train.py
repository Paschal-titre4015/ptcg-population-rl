"""Train the official-deck Iono structured Transformer on GBDT replays."""
...
from agents.iono.transformer.features import CONTRACT_ID
from agents.iono.transformer.train import train
