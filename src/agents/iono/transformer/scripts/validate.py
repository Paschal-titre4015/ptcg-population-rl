...
from agents.iono.transformer.scripts.audit import ROOT, audit
...
def validate(
    ...
    matchups = [
        ("iono_transformer", "iono_gbdt"),
        ("iono_gbdt", "iono_transformer"),
        ("iono_transformer", "iono_transformer"),
    ]
    results = []
    with tempfile.TemporaryDirectory() as temporary:
        ...
        for i, (a, b) in enumerate(matchups):
            command = [
                ...
                b,
                "--deck-a",
                str(ROOT / "src/agents/iono/deck.csv"),
                "--deck-b",
                str(ROOT / "src/agents/iono/deck.csv"),
                "--games",
                "2",
