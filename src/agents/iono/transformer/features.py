...
from agents.iono.gbdt.features import (
    DECK_COUNTS,
    IDS,
    SCHEMA,
    SCHEMA_ID,
...
from agents.iono.transformer.contract import SCORE_TIE_TOLERANCE
...
CONTRACT = dict(
    version="iono-entity-transformer-v2",
    ...
    features="public-iono-entity-v2; conservative deck/prize belief; attack outcomes unknown and flagged uncertain",
)
