"""Train and export the Dragapult ex GBDT from extracted game-split features."""
...
from agents.dragapult.gbdt.features import DECK_COUNTS, NAMES, SCHEMA_ID
from agents.dragapult.gbdt.train import train


def main() -> None:
    """Parse command-line arguments and run this tool."""
    p = argparse.ArgumentParser(description=__doc__)
    p.add_argument("--feature-dir", type=Path, default=ROOT / "outputs/dragapult/gbdt_features")
    p.add_argument("--output-dir", type=Path, default=ROOT / "models/dragapult")
    p.add_argument(
        "--profile",
