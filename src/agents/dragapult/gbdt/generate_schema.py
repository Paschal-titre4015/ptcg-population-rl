...
from agents.dragapult.gbdt.rich_features import names as rich_names
from agents.dragapult.transformer.features import CONTRACT_ID, SCORE_TIE_TOLERANCE

SCHEMA_PATH = ROOT / "src/agents/dragapult/gbdt/schema.json"
...
if __name__ == "__main__":
    generate(ROOT / "build/generated/dragapult_schema.h")
