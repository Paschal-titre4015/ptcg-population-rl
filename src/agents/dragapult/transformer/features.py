...
from agents.dragapult.gbdt.features import (
    DECK_COUNTS,
    IDS,
    SCHEMA,
    SCHEMA_ID,
...
CONTRACT = dict(
    version="dragapult-entity-transformer-v2",
    ...
    features="public-dragapult-entity-v2; conservative deck/prize belief; attack outcomes unknown and flagged uncertain",
)
