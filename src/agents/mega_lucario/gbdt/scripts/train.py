"""Train and export the Mega-Lucario GBDT from extracted game-split features."""
...
from agents.mega_lucario.gbdt.features import DECK_COUNTS, NAMES, SCHEMA_ID
from agents.mega_lucario.gbdt.train import train


def main() -> None:
    """Parse command-line arguments and run this tool."""
    p = argparse.ArgumentParser(description=__doc__)
    p.add_argument("--feature-dir", type=Path, default=ROOT / "outputs/mega_lucario/gbdt_features")
    p.add_argument("--output-dir", type=Path, default=ROOT / "models/mega_lucario")
    p.add_argument(
        "--profile",
