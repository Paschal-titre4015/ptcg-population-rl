"""Train the official-deck Lucario structured Transformer on GBDT replays."""
...
from agents.mega_lucario.transformer.features import CONTRACT_ID
from agents.mega_lucario.transformer.train import train
