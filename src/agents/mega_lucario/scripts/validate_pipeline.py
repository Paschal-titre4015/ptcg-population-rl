...
from agents.mega_lucario.gbdt.features import DECK_COUNTS, SCHEMA_ID
from agents.mega_lucario.gbdt.features import NAMES as GBDT_NAMES
from agents.mega_lucario.gbdt.scripts.audit import audit as audit_gbdt
from agents.mega_lucario.gbdt.scripts.extract import extract as extract_gbdt
from agents.mega_lucario.gbdt.train import train as train_gbdt
from agents.mega_lucario.ppo.scripts.collect import DEFAULTS, collect
from agents.mega_lucario.ppo.train import train as train_ppo
from agents.mega_lucario.transformer.checkpoint import load_checkpoint
from agents.mega_lucario.transformer.features import CONTRACT_ID, NAMES
from agents.mega_lucario.transformer.scripts.audit import audit as audit_transformer
from agents.mega_lucario.transformer.scripts.export import export
from agents.mega_lucario.transformer.scripts.extract import extract as extract_transformer
from agents.mega_lucario.transformer.train import train as train_transformer
...
def validate(output: Path, binary: Path, device: str = "cuda") -> dict[str, Any]:
    ...
    tp = audit_transformer(
        ...
        output / "distillation",
        binary.parent / "transformer_probe",
        8,
    )
    rollout = collect(
        checkpoint,
